...
class BenchmarkPieceTest < ActiveSupport::TestCase
  def setup
  ...
  def test_delete__with_query_params_and_post_body
    @benchmark.delete "/hello/world", {:hello => "world"}, {:body => "data"}
    assert_equal ["/hello/world?_method=delete&hello=world method=POST contents='body=data'"], @benchmark.buffer
  end
